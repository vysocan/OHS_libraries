...
#define AT_WAIT            50          // how many delay loops wait for modem response by default
...
#define GSM_DEFAULT_TIMEOUT      5000L
...
class NilGPRS_0 : public Print {
  ...
  public:
    ...
    NilGPRS_0(gsm_rx_ring_buffer *, gsm_tx_ring_buffer *);
    ...
    //int8_t  sendData(char *what, uint8_t length = 0, uint16_t timeout = GSM_DEFAULT_TIMEOUT);
