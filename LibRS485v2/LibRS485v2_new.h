...
#define MSG_SIZE (MSG_HEADER_SIZE + MSG_DATA_SIZE + MSG_CRC_SIZE)
#define LINE_READY_TIME_OUT 100  // max 255
// Define buffer sizes
#define USART_RX_BUFFER_SIZE MSG_SIZE
#define USART_TX_BUFFER_SIZE MSG_SIZE
...
class LibRS485v2 // : public Print
{
  ...
  public:
    ...
    int8_t send_msg(RS485_msg *msg, uint8_t repeat, uint8_t ack);
